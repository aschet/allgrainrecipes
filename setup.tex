...
\newenvironment{yeastsx} {\recipiesection{images/yeast.pdf}{Yeast}
\begin{tabu} to \textwidth {Xr}
...
\newenvironment{mashsteps} {\recipiesection{images/mash.pdf}{Mash}
...
\newenvironment{fermentationsteps} {\recipiesection{images/ferment.pdf}{Fermentation} 
\begin{tabu} to \textwidth {Xr}}{\end{tabu}}
...
\newcommand{\styleblondale}{Blonde Ale}
\newcommand{\stylebohemianpilsner}{Bohemian Pilsner}
\newcommand{\stylebrownporter}{Brown Porter}
...
\newcommand{\styleeuropeanamberlager}{European Amber Lager}
...
\newcommand{\styleoktoberfest}{Oktoberfest / Märzen}
\newcommand{\stylepilsner}{Pilsner}
\newcommand{\stylerobustporter}{Robust Porter}
...
\newcommand{\stylescottishlight}{Scottish Light 60/-}
\newcommand{\stylespecialtybeer}{Specialty Beer}
\newcommand{\stylestandardordinarybitter}{Standard / Ordinary Bitter}
...
\newcommand{\waterprofile}[6]{\ce{Ca} #1~ppm, \ce{Mg} #2~ppm, \ce{SO4} #3~ppm, \ce{Na} #4~ppm, \ce{Cl} #5~ppm, \ce{HCO3} #6~ppm}
