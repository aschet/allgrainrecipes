...
\newcommand{\styleamericanwheatorrye}{American Wheat or Rye}
\newcommand{\stylebalticporter}{Baltic Porter}
\newcommand{\stylebelgianandfrenchale}{Belgian and French Ale}
...
\specitem{IBU} & \ifthenelse{\isempty{#6}}{--}{#6} \\ \midrule
\specitem{EBC} & \ifthenelse{\isempty{#7}}{--}{#7} \\ \midrule
