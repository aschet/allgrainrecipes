...
\hop{\hopwarrior}{17~\%}{\dryh{}{1~week}}{\oztog{0.5}}
...
\begin{aboutblock}
Recipe by Nicholas Slay. Won best of show in the 2017 Minnesota Mashout Competition. \sourcezymurgy{May / June 2017}
\end{aboutblock}
...
\fermentationstep{\ftoc{72}}{Free raise to; 1~week}
\end{fermentationsteps}

\begin{directions}
On day 7, add dry hops and allow temperature to free raise to \ftoc{72}.
\end{directions}
...
\hop{\hopcitra}{12~\%}{\dryh{}{1~week}}{\oztog{3}}
\end{hops}
...
\begin{directions}
Age 1 week in secondary. Package with \oztog{5} priming sugar and condition
for 2 weeks.
\end{directions}
...
% -----------------------------------------------------------------------------
\begin{recipe}{Lynnwood Brewing Drop Bear APA Clone}
% -----------------------------------------------------------------------------
...
to \ftoc{190} the better, but anything under \ftoc{200} will work. Add the
