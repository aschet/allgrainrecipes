...
% -----------------------------------------------------------------------------
\begin{recipe}{A Festbier For the Rest Of Us}
% -----------------------------------------------------------------------------
...
\begin{malts}
\malt{\maltweyermannbohemianpilsner}{\lbtokg{5}}
\malt{\maltweyermannmunichone}{\lbtokg{4}}
\malt{\maltweyermannvienna}{\lbtokg{3}}
\end{malts}
...
\begin{malts}
\malt{\maltweyermannpilsner}{\lboztokg{12}{3.2}}
\malt{\maltmunich}{\lboztokg{9}{1}}
\malt{\maltvienna}{\oztokg{13.9}}
\malt{Briess Caramel 60 L}{\oztokg{8}}
\end{malts}
...
\begin{malts}
\malt{\maltmunich}{\lbtokg{6.5}}
\malt{\maltflakedmaize}{\oztokg{12}}
\malt{\maltweyermanncaramunichone}{\oztokg{8}}
\malt{Aromatic}{\oztokg{7}}
\malt{\maltacidulated}{\oztokg{3}}
\malt{Dingemans Special B}{\oztokg{3}}
\malt{Gambrinus Honey}{\oztokg{3}}
\end{malts}
...
% -----------------------------------------------------------------------------
\begin{recipe}{Homebrew Challenge Festbier}
% -----------------------------------------------------------------------------
...
\begin{malts}
\malt{\maltpilsner}{\lboztokg{9}{8}}
\malt{\maltweyermannmunichone}{\lboztokg{1}{8}}
...
\begin{malts}
\malt{\maltweyermannmunichone}{\lbtokg{9.75}}
\malt{\maltweyermannvienna}{\lbtokg{4.9}}
\malt{\maltweyermannpilsner}{\lbtokg{4}}
\malt{\maltweyermannmelanoidin}{\lbtokg{1}}
\malt{\maltweyermannacidulated}{\oztokg{2.9}}
\end{malts}
...
\begin{malts}
\malt{\maltweyermannvienna}{\lbtokg{10}}
\malt{\maltweyermannmunichtwo}{\lbtokg{3.5}}
\malt{\maltweyermannacidulated}{\lbtokg{0.3}}
\end{malts}
