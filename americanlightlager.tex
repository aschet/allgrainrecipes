...
\begin{malts}
\malt{\maltsixrow}{\lbtokg{8.56}}
\malt{\maltflakedmaize}{\lbtokg{2.12}}
\end{malts}
...
% -----------------------------------------------------------------------------
\begin{recipe}{Homebrew Challenge American Light Lager}
% -----------------------------------------------------------------------------
...
\specifications{\styleamericanlightlager}{\galtol{5}}{}{}{}{11}{}{60~min}{}
...
\begin{malts}
\malt{\malttworow}{\lbtokg{4}}
\malt{\maltpilsner}{\lbtokg{4}}
\malt{\maltflakedrice}{\lboztokg{2}{8}}
\end{malts}
...
% -----------------------------------------------------------------------------
\begin{recipe}{Joker's \#1 Light Lager}
% -----------------------------------------------------------------------------
...
\malt{\maltflakedrice}{\lbtokg{2.8}}
\end{malts}
...
% -----------------------------------------------------------------------------
\begin{recipe}{Kein Bier Light Lager}
% -----------------------------------------------------------------------------
...
\malt{\maltflakedrice}{\lbtokg{1}}
\malt{\maltweyermanncarahell}{\lbtokg{0.25}}
\end{malts}
...
\begin{malts}
\malt{\maltsixrow}{\lbtokg{6.05}}
\malt{\maltflakedrice}{\lbtokg{2.98}}
\end{malts}
...
\begin{malts}
\malt{\maltsixrow}{\lbtokg{8}}
\malt{\maltflakedrice}{\lbtokg{6.8}}
\end{malts}
