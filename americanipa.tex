...
Dry hop 7~days into fermentation. Allow two hearted clone to stay warm with hops
for 7~days. Transfer beer, crash cool, and cold age for 7~days.
\end{directions}
...
\hop{\hopcentennial}{9.1~\%}{\dryh{}{7~days}}{\oztog{3.5}}
\end{hops}
...
% -----------------------------------------------------------------------------
\begin{recipie}{Bissel Brothers Brewing The Substance New England IPA}
% -----------------------------------------------------------------------------
...
\malt{Briess Carapils}{\oztokg{12}}
...
% -----------------------------------------------------------------------------
\begin{recipie}{Fargo Brewing Company Wood Chipper IPA}
% -----------------------------------------------------------------------------
...
\begin{directions}
If you don't have the equipment to conduct a whirlpool at the end of the boil, simply
conduct a hop stand by steeping the final addition of Mosaic in the hot wort for 10
minutes before chilling. Add dry hops for 3 days, prior to packaging. 
\end{directions}
...
% -----------------------------------------------------------------------------
\begin{recipie}{Good Word Brewing Never Sleep New England IPA}
% -----------------------------------------------------------------------------
...
\begin{directions}
After boil, add whirlpool hops once wort is below \ftoc{180} to prevent isomerization
of hops. Dry hop for 3 days when final gravity is within 0.5--1.0 °P. Complete a
diacetyl rest before cold crashing. Crash at \ftoc{32} for 4--6 days.
\end{directions}
...
% -----------------------------------------------------------------------------
\begin{recipie}{Green Flash West Coast IPA}
% -----------------------------------------------------------------------------
...
% -----------------------------------------------------------------------------
\begin{recipie}{Perfect Plain Brewing Co. Holy Spin American IPA}
% -----------------------------------------------------------------------------
...
reached, add thecremaining \oztog{5} of Citra dry hops for 5 days.
\end{directions}
...
% -----------------------------------------------------------------------------
\begin{recipie}{Providence Brewing Company Battlecow Galacticose New England IPA}
% -----------------------------------------------------------------------------
...
with a 30 second burst of \ce{CO2} to rouse the hops. Add \oztog{2} Citra
and \oztog{2} Mosaic pellet hops 8--10 days later. Just before kegging your beer,
...
% -----------------------------------------------------------------------------
\begin{recipie}{Red Door Brewing Company New England IPA}
% -----------------------------------------------------------------------------
...
added a couple of new hop varieties that were not in existence when the brewery in Temecula was open."
\end{aboutblock}
...
% -----------------------------------------------------------------------------
\begin{recipie}{Von Ebert Brewing Sabrage Brut IPA}
% -----------------------------------------------------------------------------
...
% -----------------------------------------------------------------------------
\begin{recipie}{WeldWerks Brewing Juicy Bits NEIPA}
% -----------------------------------------------------------------------------
...
% -----------------------------------------------------------------------------
\begin{recipie}{Whetstone Station Brewery Whetstoner Session IPA}
% -----------------------------------------------------------------------------
...
% -----------------------------------------------------------------------------
\begin{recipie}{Zipline Brewing Co. NZ IPA}
% -----------------------------------------------------------------------------
