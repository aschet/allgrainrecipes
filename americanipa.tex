...
\begin{directions}
Dry hop at high krausen and carbonate to 2.5 volumes \ce{CO2}.
\end{directions}
...
hops 48 hours after the start of primary fermentation, being careful to prevent
as much oxygen pickup as possible. Once final gravity is reached, add the
remaining \oztog{5} of Citra dry hops for 5 days. Crash and carbonate to 2.5
volumes \ce{CO2}.
\end{directions}
...
precipitate out the trub. Bottle or keg with 2.6 volumes \ce{CO2}.
\end{directions}
...
\begin{directions}
Carbonate to 3.0 volumes \ce{CO2}. For a special version of this recipe, try
incorporating a grape varietal into the fermentation.
\end{directions}
...
\begin{directions}
Carbonate to 2.3 volumes \ce{CO2}.
\end{directions}
