...
for 7~days. Transfer beer, cold crash, and cold age for 7~days.
\end{directions}
...
"dank" with a perceived bitterness that contributes to an overall balanced experience. \sourceaha
\end{aboutblock}
...
\fermentationstep{\ftoc{34}}{Reduce to over 14~days}
\end{fermentationsteps}
...
isomerization of hops. Dry hop for 3 days when final gravity is within
...
\fermentationstep{\ftoc{72}}{Raise to over 7~days}
\end{fermentationsteps}
...
% -----------------------------------------------------------------------------
\begin{recipie}{Odell IPA C}lone
% -----------------------------------------------------------------------------
...
hops 48 hours after the start of fermentation. Once full attenuation
is reached, add thecremaining \oztog{5} of Citra dry hops for 5 days.
\end{directions}
...
added a couple of new hop varieties that were not in existence when the brewery in Temecula was open." \sourcezymurgy{July/August 2012}
\end{aboutblock}
...
thus the name Juicy Bits." \sourcezymurgy{Jul/Aug 2018}
\end{aboutblock}
...
4.5~\% ABV this crisp beer is perfect for when you've got thirst that needs quenching. \sourceaha
\end{aboutblock}
