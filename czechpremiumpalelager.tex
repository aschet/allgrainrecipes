...
% -----------------------------------------------------------------------------
\begin{recipe}{Hobo BoHo Pilsner} % checked
% -----------------------------------------------------------------------------
...
\begin{directions}
Water adjustment: use water with a minimum of \ppmtopptm{50} calcium and
minimal levels of other minerals. Instead of decoction, a single infusion
mash at \ftoc{150} may be performed.
\end{directions}
...
% -----------------------------------------------------------------------------
\begin{recipe}{Meister Groll Bohemian Pils} % checked
% -----------------------------------------------------------------------------
