...
% -----------------------------------------------------------------------------
\begin{recipe}{Earth Rider Brewery Precious Material Helles Clone}
% -----------------------------------------------------------------------------
...
\begin{malts}
\malt{\maltweyermannbohemianpilsner}{\lbtokg{25}}
\malt{\maltvienna}{\lbtokg{3}}
\malt{\maltmunich}{\lbtokg{1.5}}
\malt{\maltweyermanncarahell}{\lbtokg{0.75}}
\end{malts}
...
\begin{malts}
\malt{\maltpilsner}{\lbtokg{9.5}}
\malt{Torrified Wheat}{\lbtokg{1}}
\malt{Melanoidin}{\oztokg{5}}
\malt{\maltacidulated}{\oztokg{7}}
\end{malts}
...
% -----------------------------------------------------------------------------
\begin{recipe}{Homebrew Challenge Munich Helles}
% -----------------------------------------------------------------------------
...
\malt{\maltweyermannbarkepilsner}{\lbtokg{4}}
\malt{BEST Munich}{\lbtokg{1}}
\malt{BEST Vienna}{\lbtokg{1.25}}
\malt{\maltweyermanncarafoam}{\oztokg{4}}
\malt{\maltweyermanncarahell}{\oztokg{2}}
\end{malts}

\begin{hops}
\hop{\hoptettnang}{3.2~\%}{\fwh}{\oztog{1}}
\hop{\hoptettnang}{3.2~\%}{15~min}{\oztog{1}}
\end{hops}
...
\specifications{\stylemunichhelles}{\galtol{7}}{1.051}{1.010}{5.4~\%}{19.6}{\srmtoebc{4.6}}{60~min}{2.5}
...
\begin{fermentationsteps}
\fermentationstep{\ftoc{48}}{42~days}
\end{fermentationsteps}
...
\begin{malts}
\malt{\maltpilsner}{\lbtokg{14.25}}
\malt{\maltmunich}{\lbtokg{0.44}}
\malt{Dingemans Biscuit}{\lbtokg{0.16}}
\malt{Melanoidin}{\lbtokg{0.16}}
\end{malts}

\begin{hops}
\hop{\hophallertaumittelfruh}{}{\fwh}{\oztog{1.8}}
\end{hops}
