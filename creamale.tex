...
\malt{\maltcarapils}{\lbtokg{2}}
\malt{\maltflakedmaize}{\lbtokg{2}}
\malt{\maltflakedrice}{\lbtokg{1.5}}
\malt{Gambrinus Honey}{\oztokg{12}}
\end{malts}
...
\begin{malts}
\malt{\malttworow}{\lbtokg{9.75}}
\malt{\maltflakedmaize}{\lbtokg{1.25}}
...
\malt{\maltflakedmaize}{\lbtokg{4}}
\malt{\maltflakedbarley}{\lbtokg{1}}
...
\begin{malts}
\malt{\maltpilsner}{\lbtokg{4.75}}
\malt{\malttworow}{\lbtokg{4.75}}
\malt{\maltflakedmaize}{\lbtokg{1}}
\end{malts}
...
% -----------------------------------------------------------------------------
\begin{recipe}{Homebrew Challenge Cream Ale}
% -----------------------------------------------------------------------------
